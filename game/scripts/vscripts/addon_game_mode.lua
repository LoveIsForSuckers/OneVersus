...
--[[
  ...
  -- Heavy custom particles
  PrecacheResource("particle", "particles/units/heroes/hero_frost/abzero.vpcf", context)
  PrecacheResource("particle", "particles/units/heroes/hero_arcane/arcane_shard_crystal.vpcf", context)
  
  -- Default particles used for custom items
  ...
  -- Default hero sounds used for custom items
